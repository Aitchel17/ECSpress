function [idx, kymograph_mask,parameter] = analyze_fwhm(kymograph)
    ...
    idx.upperboundary = upperboundary_idx + upcropval;
    idx.lowerboundary = lowerboundary_idx + upcropval;
    cla(ax,'reset')
    imagesc(ax,kymograph)
    hold on
    plot(idx.upperboundary,'r')
    plot(idx.lowerboundary, 'r')
