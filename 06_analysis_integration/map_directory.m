...
save_path = 'E:\OneDrive - The Pennsylvania State University\2023ecspress\01_primary_analysis\01_ecspress';
...
state_map = {'paxfwhm_state', 'paxfwhm_state.mat'
    };
...
% Create Table
session_table = struct2table(cols);

% Sort by date
if ~isempty(session_table)
    session_table = sortrows(session_table, 'Date');
end

% Display first few rows
disp('Session Table Created (session_table):');
head(session_table)
