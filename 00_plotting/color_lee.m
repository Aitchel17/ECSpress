classdef color_lee
    ...
    properties (Constant)
        % The last six are sleep states, not colour names. They sit here for the
        % same reason polarity() does: two figures that colour the same state
        % differently get misread, and this is the only place both of them look.
        % plot_sleep_patches reads them from here rather than keeping its own copy.
        clist = struct(...
            'white', [1,1,1],...
            'black', [0,0,0],...
            'cyan', [0,1,1],...
            ...
            'nrem', [0.00, 0.45, 0.90],...
            'rem', [0.85, 0.10, 0.10],...
            'awake', [0.10, 0.10, 0.10],...
            'drowsy', [0.20, 0.65, 0.20],...
            'uarousal', [0.93, 0.49, 0.19],...
            'trans', [0.50, 0.10, 0.70]);
    end
